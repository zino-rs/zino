...
pub fn schema_macro(item: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        static #schema_columns: LazyLock<Vec<zino::Column>> = LazyLock::new(|| {
            vec![#(#columns),*]
        });
        static #schema_reader: OnceLock<&zino::ConnectionPool> = OnceLock::new();
        static #schema_writer: OnceLock<&zino::ConnectionPool> = OnceLock::new();

        #[async_trait::async_trait]
        impl zino::Schema for #name {
            /// Type name as a str.
            ...
            #[inline]
            fn columns() -> &'static[zino::Column<'static>] {
            ...
            async fn init_reader() -> Option<&'static zino::ConnectionPool> {
            ...
            async fn init_writer() -> Option<&'static zino::ConnectionPool> {
