...
pub use crate::completions::content::Content;
pub use crate::completions::messages::Message;
...
impl MemoryStats {
    ...
    /// Get message distribution ratios (user, assistant, system, tool)
    pub fn get_message_distribution(&self) -> (f64, f64, f64, f64) {
        ...
        let tool_ratio = self.tool_messages as f64 / self.total_messages as f64;

        (user_ratio, assistant_ratio, system_ratio, tool_ratio)
    }
}
